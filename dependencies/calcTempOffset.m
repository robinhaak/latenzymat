function [tempDiff,relSpikeTimes,spikeFracs,fracLinear] = calcTempOffset(spikeTimes,eventTimes,useMaxDur)
% compute temporal offset vector, syntax:
%   [tempDiff,relSpikeTimes,spikeFracs,fracLinear] = calcTempOffset(spikeTimes,eventTimes,useMaxDur)
%
% history:
% 2 Aug 2023
